...
urlpatterns += [
	...
	url(r'^addcitation', AddCitation.as_view()),
	url(r'^showcitation', ShowCitation.as_view()),
	url(r'^showallcitation', ShowAllCitation.as_view()),
	url(r'^deletecitation', DeleteCitation.as_view()),
